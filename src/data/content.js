export const portfolio = {
  hero: {
    name: "Nathan West",
    title: "Software Engineer & Computer Science New-Grad",
    availability: "Open to new-grad roles",
    photo: "profilepic.jpeg",
    summary:
      "Software Engineer who enjoys building complex systems end-to-end. My work primarily consists of designing expressive React front-ends, data-rich APIs, and automation pipelines that keep teams shipping fast.",
  ...
  highlights: [
    ...
    {
      label: "Teaching",
      value: "200+ students mentored with CodeWizardsHQ",
    },
    {
      label: "Leadership",
      value: "Lead, Stampede Development Team",
    },
  ],
  quickStats: [
    {
      value: "20k Active Users",
      label: "Lead Developer on Stampede, a university e-commerce app",
    },
    {
      value: "35%",

  ...
  return (
    <section id="contact" className="py-16">
      <div className={containerClass}>
        <div className="grid gap-8 rounded-3xl border border-accent/20 bg-gradient-to-br from-white to-indigo-50 p-10 shadow-panel transition lg:grid-cols-[minmax(0,1fr)_300px] dark:border-white/10 dark:from-nightSurface dark:to-night">
          <div>
          ...
          <div className="flex flex-col gap-4">
            <a
              className="inline-flex items-center justify-center rounded-full bg-accent px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-accent/30 transition hover:-translate-y-0.5"

        ...
        <div className="mt-10 space-y-8 border-l border-slate-200 pl-6 dark:border-slate-700/70">
          {experience.map((role) => (
            <article key={role.role} className="relative pl-6">
              <span className="absolute left-0 top-2 -translate-x-1/2 transform rounded-full border-4 border-white bg-accent shadow dark:border-night dark:bg-accent"></span>
              <div className="rounded-3xl border border-slate-200 bg-white p-7 shadow-card transition dark:border-slate-700/60 dark:bg-nightSurface">
